...
exports.state = exports.StatePlugin = void 0;
...
class StatePlugin {
    ...
    attachListeners() {
        ...
        runtime_client_1.runtimeClient.on('runtime.started', () => this.updateState());
        runtime_client_1.runtimeClient.on('runtime.stopped', () => this.updateState());
        runtime_client_1.runtimeClient.on('status.updated', (status) => this.displayState(status));
        runtime_client_1.runtimeClient.on('pipeline.event', () => this.updateState());
        // Initial state
        this.updateState();
    }
    updateState() {
...
exports.StatePlugin = StatePlugin;
exports.state = new StatePlugin();
